...
import { faGoogle, faInstagram, faLinkedin, faTwitter, faWhatsapp } from '@fortawesome/free-brands-svg-icons';
import './Carousel.css';
import './Home.css';
...
import { faAddressCard, faMailBulk, faMapMarkerAlt, faMobileScreen, faPhone, faWalkieTalkie } from "@fortawesome/free-solid-svg-icons";
        ...
        {carouselItems.map((item) => (
          ...
          <div class="container">
            ...
            <div class="row" >
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style={{borderRadius: '50%'}}>
                        <img class="img-fluid w-100" src={pp3} alt=""  style={{height: '250px', width: '150px'}} />
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style={{width: '38px', height: '38px'}}
                                href="#"><FontAwesomeIcon  icon={faTwitter} /></a>
                ...
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style={{borderRadius: '50%'}}>
                        <img class="img-fluid w-100" src={pp4} alt=""  style={{height: '250px', width: '150px'}}/>
                        <div
                            class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                            <a class="btn btn-outline-light text-center mr-2 px-0" style={{width: '38px', height: '38px'}}
                                href="#"><FontAwesomeIcon  icon={faTwitter} /></a>
