...
function ResetPassword() {
  ...
  function handleResetPassword(event) {
    ...
    if (!password || !confirmPassword) {
      ...
      forgotAndChangePassword(token, password)
        .then((data) => {
          console.log(data);
          ...
          <Col sm={{ size: 8, offset: 2 }}>
            <Card className=" shadow border border-dark">
              <CardHeader className="bg-primary">
                ...
                <p>
                  NOTE: New password should be in between 8 to 20 characters &
                  must contain atleast one small alphabet,one capital aplhabet
                  and a number.{" "}
                </p>
              </CardHeader>
