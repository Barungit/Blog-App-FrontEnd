...
function ForgotPassword() {
    ...
    const handleFormSubmit=(event)=>{
        ...
        //submit the data
        sendtoMail(email).then((data)=>{
            console.log(data)
            
            toast.success("An Email has been sent to your Email to change password! ")
        }).catch(error=>{
            console.log(error)
        ...
        <div>
            ...
            <CardBody>
                ...
                <Form onSubmit={handleFormSubmit}>
                    ...
                    <NavLink className=' text-primary' tag={ReactLink} to="/login">Click Here to go back to login page.</NavLink>
                    <NavLink className=' text-primary' tag={ReactLink} to="/signup">New user? Click here to signup!</NavLink>

                    {/* Button Fields */}
                    <Container className="text-center">
                        <Button className="shadow" type="submit" color="success">Login</Button>
                    </Container>
